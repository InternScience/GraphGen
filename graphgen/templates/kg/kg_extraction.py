...
Note: Historical examples below may use a legacy 4-field relationship format. In real extraction output, you MUST use the 7-field relationship format defined above.
...
注意：下面的历史示例可能使用旧版4字段关系格式。实际抽取输出时，必须使用上面定义的7字段关系格式。
